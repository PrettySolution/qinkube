...
import (
	...
	scheme "github.com/prettysolution/vfs-workflows/pkg/generated/clientset/versioned/scheme"
...
func newKlusters(c *WorkflowV1alpha1Client, namespace string) *klusters {
	return &klusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
